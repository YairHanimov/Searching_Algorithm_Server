...
//                                "end";
            ...
            string testbuffer = "8,9,-1,2,7,8,1,1,1,7,9,3,9,9,7,2,6,8\n"
                                "0,0,1,7,4,6,4,0,2,2,1,1,4,6,2,4,3,6\n"
                                "8,2,8,8,1,-1,-1,0,7,4,9,-1,3,0,9,4,7,5\n"
                                "4,9,5,4,0,5,2,6,1,8,-1,4,7,3,0,2,3,2\n"
                                "9,5,8,8,2,4,0,5,5,-1,1,9,7,5,9,0,-1,8\n"
                                "4,1,2,-1,0,0,8,3,7,2,2,1,9,-1,2,5,1,6\n"
                                "8,0,-1,7,6,9,1,8,0,0,9,6,7,5,3,7,5,9\n"
                                "9,0,2,1,-1,8,5,5,9,7,8,4,0,4,4,1,3,-1\n"
                                "2,-1,9,8,8,9,6,9,1,1,9,8,0,2,4,2,8,5\n"
                                "6,5,1,1,5,0,-1,8,-1,4,7,0,4,2,2,2,9,9\n"
                                "3,1,3,-1,6,-1,5,3,3,1,1,5,-1,5,6,7,4,6\n"
                                "7,0,5,3,8,-1,8,-1,9,0,6,1,5,-1,2,4,6,9\n"
                                "4,3,0,0,1,2,1,0,7,8,-1,1,9,9,4,1,3,1\n"
                                "8,0,1,3,5,3,6,7,1,7,-1,4,4,8,4,7,-1,3\n"
                                "0,-1,6,7,6,6,5,5,2,5,7,0,-1,4,8,3,-1,1\n"
                                "6,9,5,7,4,2,3,9,-1,0,2,8,7,7,7,1,8,9\n"
                                "3,4,7,8,3,4,0,8,-1,5,0,1,3,-1,4,3,4,3\n"
                                "-1,2,5,6,2,4,3,-1,5,7,5,0,6,7,-1,5,2,3\n"
                                "0,0\n"
                                "17,17\n"
                                "end";
